...
#
# Generated on 2026-09-24T16:15:33Z by kres c0dd940.
...
.PHONY: sign-image-talos-metal-agent
sign-image-talos-metal-agent:  ## Signs the image for talos-metal-agent. Requires interactive Google authentication.
	@test -n "$$GITHUB_TOKEN" || { \
	...
	@TMP=$$(mktemp -d) && trap 'rm -rf "$$TMP"' EXIT && \
	  ...
	  docker run --rm -p 127.0.0.1:8585:8585 \
	    ...
	    $(REGISTRY)/$(USERNAME)/talos-metal-agent:$(IMAGE_TAG)
